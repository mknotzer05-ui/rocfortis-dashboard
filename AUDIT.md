...
2. **Die fünf Leistungsseiten haben keine H1.** SEA, AIR, LAND, SUPPLY und INTEL — die Seiten, auf denen das Geschäft erklärt wird, je rund 900 Wörter — benennen ihr Hauptthema in keiner Überschrift erster Ordnung.
...
Der letzte Punkt verdient Betonung: Viele Unternehmen sperren KI-Crawler versehentlich aus und wundern sich dann über fehlende Sichtbarkeit. Hier ist der Zugang offen — die Grundlage stimmt.
...
**Warum das zählt:** Drei Gründe, in dieser Reihenfolge. Erstens Barrierefreiheit — Screenreader-Nutzer erfahren nicht, was abgebildet ist; die Website eines Unternehmens, das mit Behörden arbeitet, sollte hier sauber sein. Zweitens: KI-Systeme lesen keine Bilder, sie lesen Alt-Texte. Drittens Bildersuche.
...
**Warum das zählt:** `sameAs` ist der Verweis, mit dem eine Marke als Entität verankert wird — Verknüpfungen zu LinkedIn, Wikidata, Handelsregister. Ohne diese Verweise ist „RocFortis Group" für ein KI-System eine Zeichenkette, kein Unternehmen. Das erklärt einen erheblichen Teil des GEO-Rückstands.
...
**Gemessen:** 82 Prozent der Titel überschreiten 60 Zeichen; der längste hat 124. Median 70. Außerdem drei doppelte Titel: *Offerings*, *RocUnits* und *Privacy Policy* jeweils zweimal — die deutsche und die englische Fassung tragen denselben Titel.
...
- **FAQPage** dort, wo Fragen beantwortet werden — der mit Abstand direkteste Weg in KI-Antworten, weil Frage-Antwort-Paare genau das Format sind, das diese Systeme zitieren.
...
|---|---|---|---|---|
| RocFortis Group Sicherheit Verteidigung Österreich | Marke | gefunden | 1 | — |
| OSINT Frühwarnsystem geopolitische Risiken | Fachthema | gefunden | 1 | — |
| Maritime Sicherheit kritische Unterwasserinfrastruktur | Fachthema | gefunden | 7 | — |
| Dual-Use Ausfuhrgenehmigung Beratung | Kaufabsicht | nicht gefunden | — | Rödl & Partner, WINHELLER |
| Drohnen UAV Aufklärung KI Österreich | Kaufabsicht | nicht gefunden | — | ProSafe, PSM Austria |
| Industriespionage Schutz Beratung Risikoanalyse | Kaufabsicht | nicht gefunden | — | SIUS Consulting, WDS |
...
Bemerkenswert ist der Fall Dual-Use: RocFortis hat einen ausführlichen Artikel zum Thema, wird aber bei der Anbietersuche nicht gefunden — gegen Kanzleien, die eine Leistungsseite dazu haben. Der Inhalt ist da, nur im falschen Format.
...
|---|---|---|
| hreflang auf allen Seiten | 0,5–1 Tag | beendet die Sprachkonkurrenz |
...
| Alt-Texte für den Bildbestand | 1–2 Tage |
| Zehn fehlende Meta-Beschreibungen ergänzen | 2 Std. |
| Ungenutztes CSS entfernen, JavaScript bündeln | 1–2 Tage |
